                ...
                <div class="row gy-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            <a href="index.html"><img alt="image" src="{{asset('/images/icons/footer1-logo.svg')}}"></a>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex justify-content-lg-center">
                        <div class="footer-item">
                            ...
                            <ul class="footer-list">
                                <li><a href="{{ route('services') }}">Strategy & Research</a></li>
                                <li><a href="{{ route('services') }}">Web Development</a></li>
                                <li><a href="{{ route('services') }}">Web Solution</a></li>
                                <li><a href="{{ route('services') }}">Digital Merketing</a></li>
                                <li><a href="{{ route('services') }}">App Design</a></li>
                                <li><a href="{{ route('services') }}">App Development</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 d-flex justify-content-lg-center">
                        ...
                        <div class="footer-item">
                            ...
                            <ul class="address-list">
                                <li>
                                    ...
                                    <a href="#">Rehmat ullah plaza new civil line Sargodha</a>
                                </li>
                                <li>
                                    ...
                                    <a href="tel:+923006012877">+92 300 6012877</a>
                                </li>
                                <li>
                                    <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="container">
                <div class="row d-flex align-items-center g-3">
                    <div class="col-lg-6 d-flex justify-content-lg-start justify-content-center">
                        <p>Copyright 2023 <a href="#" class="egns-lab">Company</a></p>
                    </div>
